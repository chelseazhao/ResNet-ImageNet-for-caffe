...
def parse_args():
	...
	parser.add_argument('--layer_num', nargs=1, help=('the sum of layers, it should be 18, 34, 50, 101 or 152'), \
		default=152)
...
def generate_train_val(layer_sum):
	...
	'''conv1'''
	bottom = 'data'
	train_val_file += generate_conv_layer('conv1', bottom, 'conv1', 64, 7, 0, 2)
	...
	bottom = 'pool_conv1'
	if layer_sum == 18 or layer_sum == 34:
		if layer_sum == 18:
			params = [2, 2, 2, 2]
		else:
			params = [3, 4, 6, 3]
		'''conv2_x'''
		train_val_file += generate_conv_layer('res2_1_branch1', bottom, 'res2_1_branch1', 64, 1, 0, 1)
		train_val_file += generate_BN_layer('bn_res2_1_branch1', 'res2_1_branch1', 'res2_1_branch1')
		train_val_file += generate_scale_layer('scale_res2_1_branch1', 'res2_1_branch1', 'res2_1_branch1')
		...
		for i in range(1, params[0]+1):
			...
			train_val_file += generate_conv_layer(this_name, 'res2_'+str(i)+'_branch2a', this_name, 64, 3, 1, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			train_val_file += generate_activation_layer('relu_'+this_name, this_name, this_name)

			train_val_file += generate_eltwise_layer('res2_'+str(i), last_out, this_name, 'res2_'+str(i))
			train_val_file += generate_activation_layer('res2_'+str(i)+'_relu', 'res2_'+str(i), 'res2_'+str(i))
			last_out = 'res2_'+str(i)
			bottom = last_out
		'''conv3_x'''
		train_val_file += generate_conv_layer('res3_1_branch1', bottom, 'res3_1_branch1', 128, 1, 0, 2)
		train_val_file += generate_BN_layer('bn_res3_1_branch1', 'res3_1_branch1', 'res3_1_branch1')
		train_val_file += generate_scale_layer('scale_res3_1_branch1', 'res3_1_branch1', 'res3_1_branch1')
		...
		for i in range(1, params[0]+1):
			...
			train_val_file += generate_conv_layer(this_name, 'res3_'+str(i)+'_branch2a', this_name, 128, 3, 1, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			train_val_file += generate_activation_layer('relu_'+this_name, this_name, this_name)

			train_val_file += generate_eltwise_layer('res3_'+str(i), last_out, this_name, 'res3_'+str(i))
			train_val_file += generate_activation_layer('res3_'+str(i)+'_relu', 'res3_'+str(i), 'res3_'+str(i))
			last_out = 'res3_'+str(i)
			bottom = last_out
		'''conv4_x'''
		train_val_file += generate_conv_layer('res4_1_branch1', bottom, 'res4_1_branch1', 256, 1, 0, 2)
		train_val_file += generate_BN_layer('bn_res4_1_branch1', 'res4_1_branch1', 'res4_1_branch1')
		train_val_file += generate_scale_layer('scale_res4_1_branch1', 'res4_1_branch1', 'res4_1_branch1')
		...
		for i in range(1, params[0]+1):
			...
			train_val_file += generate_conv_layer(this_name, 'res4_'+str(i)+'_branch2a', this_name, 256, 3, 1, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			train_val_file += generate_activation_layer('relu_'+this_name, this_name, this_name)

			train_val_file += generate_eltwise_layer('res4_'+str(i), last_out, this_name, 'res4_'+str(i))
			train_val_file += generate_activation_layer('res4_'+str(i)+'_relu', 'res4_'+str(i), 'res4_'+str(i))
			last_out = 'res4_'+str(i)
			bottom = last_out
		'''conv5_x'''
		train_val_file += generate_conv_layer('res5_1_branch1', bottom, 'res5_1_branch1', 512, 1, 0, 2)
		train_val_file += generate_BN_layer('bn_res5_1_branch1', 'res5_1_branch1', 'res5_1_branch1')
		train_val_file += generate_scale_layer('scale_res5_1_branch1', 'res5_1_branch1', 'res5_1_branch1')
		...
		for i in range(1, params[0]+1):
			...
			train_val_file += generate_conv_layer(this_name, 'res5_'+str(i)+'_branch2a', this_name, 512, 3, 1, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			train_val_file += generate_activation_layer('relu_'+this_name, this_name, this_name)

			train_val_file += generate_eltwise_layer('res5_'+str(i), last_out, this_name, 'res5_'+str(i))
			train_val_file += generate_activation_layer('res5_'+str(i)+'_relu', 'res5_'+str(i), 'res5_'+str(i))
	...
	elif  layer_sum == 50 or layer_sum == 101 or layer_sum == 152:
		if layer_sum == 50:
			params = [3, 4, 6, 3]
		elif layer_sum == 101:
			params = [3, 4, 23, 3]
		...
		for i in range(1, params[0]+1):
			...
			train_val_file += generate_conv_layer(this_name, 'res2_'+str(i)+'_branch2b', this_name, 256, 1, 0, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			...
			bottom = last_out
		'''conv3_x'''
		train_val_file += generate_conv_layer('res3_1_branch1', bottom, 'res3_1_branch1', 512, 1, 0, 2)
		train_val_file += generate_BN_layer('bn_res3_1_branch1', 'res3_1_branch1', 'res3_1_branch1')
		train_val_file += generate_scale_layer('scale_res3_1_branch1', 'res3_1_branch1', 'res3_1_branch1')
		last_out = 'res3_1_branch1'
		for i in range(1, params[0]+1):
			if i == 1:
				...
				first_stride = 1
			this_name = 'res3_'+str(i)+'_branch2a'
			train_val_file += generate_conv_layer(this_name, bottom, this_name, 128, 1, 0, first_stride)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			train_val_file += generate_activation_layer('relu_'+this_name, this_name, this_name)
			...
			train_val_file += generate_conv_layer(this_name, 'res3_'+str(i)+'_branch2b', this_name, 512, 1, 0, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			...
			bottom = last_out
		'''conv4_x'''
		train_val_file += generate_conv_layer('res4_1_branch1', bottom, 'res4_1_branch1', 1024, 1, 0, 2)
		train_val_file += generate_BN_layer('bn_res4_1_branch1', 'res4_1_branch1', 'res4_1_branch1')
		train_val_file += generate_scale_layer('scale_res4_1_branch1', 'res4_1_branch1', 'res4_1_branch1')
		last_out = 'res4_1_branch1'
		for i in range(1, params[0]+1):
			if i == 1:
				...
				first_stride = 1
			this_name = 'res4_'+str(i)+'_branch2a'
			train_val_file += generate_conv_layer(this_name, bottom, this_name, 256, 1, 0, first_stride)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			train_val_file += generate_activation_layer('relu_'+this_name, this_name, this_name)
			...
			train_val_file += generate_conv_layer(this_name, 'res4_'+str(i)+'_branch2b', this_name, 1024, 1, 0, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			...
			bottom = last_out
		'''conv5_x'''
		train_val_file += generate_conv_layer('res5_1_branch1', bottom, 'res5_1_branch1', 2048, 1, 0, 2)
		train_val_file += generate_BN_layer('bn_res5_1_branch1', 'res5_1_branch1', 'res5_1_branch1')
		train_val_file += generate_scale_layer('scale_res5_1_branch1', 'res5_1_branch1', 'res5_1_branch1')
		last_out = 'res5_1_branch1'
		for i in range(1, params[0]+1):
			if i == 1:
				...
				first_stride = 1
			this_name = 'res5_'+str(i)+'_branch2a'
			train_val_file += generate_conv_layer(this_name, bottom, this_name, 512, 1, 0, first_stride)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
			train_val_file += generate_activation_layer('relu_'+this_name, this_name, this_name)
			...
			train_val_file += generate_conv_layer(this_name, 'res5_'+str(i)+'_branch2b', this_name, 2048, 1, 0, 1)
			train_val_file += generate_BN_layer('bn_'+this_name, this_name, this_name)
			train_val_file += generate_scale_layer('scale_'+this_name, this_name, this_name)
...
if __name__ == '__main__':
	...
	if layer_sum not in [18, 34, 50, 101, 152]:
		print "layer num is not in [18, 34, 50, 101, 152]"
		sys.exit(1)
